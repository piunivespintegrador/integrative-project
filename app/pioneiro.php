    ...
    <div style="position: relative; top: -90px;" class="cn f a j">
        <div class="wp">
            ...
            <aside style="display: flex; align-items: center;">
                <div class="zoom">
                    <div class="original">
                        <img src="images/produto/801.png" id="target">
                    </div>
                    <div class="viewer">
                        <img src="images/produto/801.png">
                    </div>
                </div>
                <!-- Availability text -->
                <div class="availability-container" style="position: relative; top: -130px;"> <!-- Ajuste o valor conforme necessário -->
                    <div class="availability"> <strong>Bateria <span style="color: #fd0101;">Pioneiro 60Ah</span></strong> <br>
                    </div>
                   </div>
...
<div class="gallery">
    <img src="images/produto/801.png" class="thumb active" alt="Image 1">
    <img src="images/produto/800.png" class="thumb" alt="Image 2">
    <img src="images/produto/801.png" class="thumb" alt="Image 3">
    <img src="images/produto/800.png" class="thumb" alt="Image 4">

    <div class="availability-container">
        <div class="availability" style="visibility: hidden;">ISCO OODE FREIO DIANT IIIFEEDIANTF</div>
    </div>
</div>
